...
def download_dataset():
    ...
    os.system("git clone -b train-val https://github.com/aleksandar-aleksandrov/groceries-object-detection-dataset.git")
    ...
    print("PascalVOC annotations converted to Florence-2 format and saved as annotations_train.jsonl and annotations_val.jsonl")
